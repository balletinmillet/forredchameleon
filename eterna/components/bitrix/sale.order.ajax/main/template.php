...
else
{
	...
	<form action="<?=POST_FORM_ACTION_URI?>" method="POST" name="ORDER_FORM" id="bx-soa-order-form" enctype="multipart/form-data">
		...
		<div id="bx-soa-order" class="row bx-<?=$arParams['TEMPLATE_THEME']?>" style="opacity: 0">
			<!--	MAIN BLOCK	-->
        <div class="col-sm-8 bx-soa column left">
            <div class="params c-item-address styled-form">
				<div id="bx-soa-main-notifications params c-item-address">
...
<!--					<div id="bx-soa-basket" data-visited="false" class="bx-soa-section bx-active">
				...
				<? endif ?>
                <!--	BUYER PROPS BLOCK	-->
                <div id="bx-soa-properties" data-visited="false" class="bx-soa-section bx-active param address-form">
<!--                    <div class="bx-soa-section-title-container param-content">
                        <h2 class="bx-soa-section-title col-sm-9">
				...
				<? if ($arParams['DELIVERY_TO_PAYSYSTEM'] === 'p2d'): ?>
					<!--	PAY SYSTEMS BLOCK	-->
					<div id="bx-soa-paysystem" data-visited="false" class="bx-soa-section param bx-active">
                        <div class="param-title col-12 col-sm-3 col-lg-4 my-auto">
...
<!--						<div class="bx-soa-section-title-container">
					...
					<!--	DELIVERY BLOCK	-->
					<div id="bx-soa-delivery" data-visited="false" class="bx-soa-section param bx-active" <?=($hideDelivery ? 'style="display:none"' : '')?>>
                        <div class="param-title col-12 col-sm-3 col-lg-4 my-auto">
...
<!--					<div id="bx-soa-basket" data-visited="false" class="bx-soa-section bx-active">
			...
			<!--	SIDEBAR BLOCK	-->
        <div id="bx-soa-total" class="col-sm-4 bx-soa-sidebar column right is_stuck" >
            <div class="bx-soa-cart-total-ghost"></div>
            <div class="bx-soa-cart-total"></div>
        </div>
		</div>

        <div id="bx-soa-delivery-pickup" style="display:none">
            <?
            $APPLICATION->IncludeComponent(
                "custom:delivery.pickup.point",
                "",
                array(
                    "ADDRESS_OBJECT_ID" => "",// 7700000000000 5500000100000 6000000100000 7800000000000
                    "ITEM_COUNT" => "1",
                    "CART_AMOUNT" => "4500",
                    "GOOGLE_API_KEY" => "AIzaSyAiHs_aPzDvyH-SXKlyJFJ6m_eX-bK461Y", //"AIzaSyAiHs_aPzDvyH-SXKlyJFJ6m_eX-bK461Y",
                    "CACHE_TYPE" => "Y",
                ),
                false
            );
	...
	<script>
		...
		BX.Sale.OrderAjaxComponent.init({
			...
			customResult: <?=CUtil::PhpToJSObject($arResult["CUSTOM_JS_DATA"])?>,
